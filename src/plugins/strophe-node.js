        ...
        */
        ...
        _dataRecv: function (req, raw)
        {
            ...
            if (this.xmlInput !== Strophe.Connection.prototype.xmlInput) {
                if (elem.nodeName.toLowerCase() === this._proto.strip && elem.childNodes.length) {
        ...
        _connect_cb: function (req, _callback, raw)
        {
            ...
            if (this.xmlInput !== Strophe.Connection.prototype.xmlInput) {
                if (bodyWrap.nodeName.toLowerCase() === this._proto.strip && bodyWrap.childNodes.length) {
...
/* global define, window, setTimeout, clearTimeout, XMLHttpRequest, ActiveXObject, Strophe, $build */
    ...
    Strophe.Request.prototype = {
        ...
        getResponse: function ()
        {
            ...
            if (this.xhr.responseXML && this.xhr.responseXML.documentElement) {
                ...
                node = new DOMParser().parseFromString(this.xhr.responseText ,'text/xml');
                node = node.childNodes[0];

                Strophe.error("responseText: " + this.xhr.responseText);
                Strophe.error("responseXML: " +
                              Strophe.serialize(node));
            }
        ...
        _processRequest: function (i)
        {
            ...
            if (req.xhr.readyState === 0) {
                ...
                if (this._conn.xmlOutput !== Strophe.Connection.prototype.xmlOutput) {
                    if (req.xmlData.nodeName.toLowerCase() === this.strip && req.xmlData.childNodes.length) {
    ...
    Strophe.Websocket.prototype = {
        ...
        _check_streamerror: function (bodyWrap, connectstatus) {
            ...
            for (var i = 0; i < error.childNodes.length; i++) {
                ...
                if (e.getAttribute("xmlns") !== ns) {
                    ...
                    condition = e.nodeName.toLowerCase();
                }
            }
        ...
        _onMessage: function(message) {
            ...
            if (this._conn.disconnecting &&
                    elem.firstChild.nodeName.toLowerCase() === "presence" &&
